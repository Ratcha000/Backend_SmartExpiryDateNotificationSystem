...
public class PurchaseRunDetailResponse {
    ...
    private List<PurchaseRecommendationResponse> items;

    public PurchaseRunDetailResponse(String runId, String restaurantId, LocalDate runDate, Instant generatedAt,
                                     ...
                                     Instant lookbackStartAt, List<PurchaseRecommendationResponse> items) {
        this.runId = runId;
    ...
    public List<PurchaseRecommendationResponse> getItems() {
        return items;
    }
}
